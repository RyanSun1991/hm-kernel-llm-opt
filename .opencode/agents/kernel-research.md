...
7. Use **Kernel Index MCP** as the primary evidence source. For every factual claim you make in the design doc, cite `file:line` (or the Kernel Index MCP query result) so the human can audit it.
