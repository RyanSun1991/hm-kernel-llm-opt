...
7. Follow `.opencode/skills/scenario/kernel-opt/optimization-funnel/SKILL.md` for ideation — the dedup step is mandatory and must cite the file:entry for every dropped idea.
