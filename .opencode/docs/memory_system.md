...
- `human_decisions/`: chronological human-agent decision logs, populated by primary-agent human workflows (`kernel-research`, `kernel-plan`) — see `.opencode/skills/human-interaction-memory/SKILL.md`
