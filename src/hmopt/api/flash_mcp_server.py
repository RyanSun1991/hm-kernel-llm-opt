...
_TOOL_DISPATCH = {
    ...
    "flash_stock": lambda args: flash_stock(**args),
    "flash_stock_async": lambda args: flash_stock_async(**args),
    "flash_feature": lambda args: flash_feature(**args),
    "flash_feature_async": lambda args: flash_feature_async(**args),
